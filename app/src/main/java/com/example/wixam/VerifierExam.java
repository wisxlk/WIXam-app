...
public class VerifierExam extends AppCompatActivity {
    ...
    @Override
    //initialisation l'activity//
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);
        setContentView(R.layout.activity_verfier_exams);
    ...
    public static void setupForegroundDispatch(final VerifierExam activity, NfcAdapter adapter) {
    ...
    public static void stopForegroundDispatch(final VerifierExam activity, NfcAdapter adapter) {
    ...
    private String verifieretudiant(String idetudiant) {
        ...
        try {
            ...
            String ulr = "http://" + MainActivity.IP + "verifierExametudiant.php/?Idetudiant=" + URLEncoder.encode(String.valueOf(idetudiant), "UTF-8")+"&enseignant="+ URLEncoder.encode(String.valueOf(ConnectActivity.userEnseignant), "UTF-8");
   ...
   private class  NdefReaderTask extends AsyncTask <Tag, Void, String> {
        ...
        protected void onPostExecute(String res) {
            ...
            if (res.equals("0")) {
             ...
             //boite.setFont(new Font("serif",Font.BOLD,14));
                Toast.makeText(VerifierExam.this, "", Toast.LENGTH_SHORT).show();
